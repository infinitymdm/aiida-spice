#
# Sphinx configuration for aiida-spice
#
...
copyright_owners = "Marcus Mellor"
...
release = aiida_spice.__version__
...
html_title = f"aiida-spice v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-spice.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_spice")
