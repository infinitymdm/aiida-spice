...
Once you're happy with your documentation, it's easy to host it online on ReadTheDocs_:
 ...
 #. Import your ``aiida-spice`` repository (preferably using ``aiida-spice`` as the project name)

The documentation is now available at `aiida-spice.readthedocs.io <http://aiida-spice.readthedocs.io/>`_.
